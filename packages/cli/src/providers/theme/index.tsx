...
const CONFIG_DIR = join(homedir(), ".mantracode");
...
function getInitialTheme(): Theme {
    try {
        const prefrences = JSON.parse(
            readFileSync(THEME_PREFERENCES_PATH, "utf8"),
        ) as Partial<ThemePreferences>;

        const savedTheme = THEMES.find((theme) => theme.name === prefrences.themeName);
